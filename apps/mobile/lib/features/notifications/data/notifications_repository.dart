...
/// FCM token, which needs `firebase_messaging` wired up first — no
/// Firebase package is a dependency at all now that login runs on
/// email OTP, so there is no real token to register.
